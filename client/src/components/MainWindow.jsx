...
export const MainWindow = () => {
    ...
    const width = 100;
    const contactsWidth = width - (60 / 100) * width;
    ...
    return (
        <div className='min-h-screen overflow-hidden max-h-screen bg-[#2C2C2C]'>
            ...
            <div className='bg-[#202020] px-3 py-2 flex items-center justify-between'>
                ...
                <div className='text-[#1BB565] font-bold cursor-pointer' onClick={logout}>
                    Logout
                </div>
